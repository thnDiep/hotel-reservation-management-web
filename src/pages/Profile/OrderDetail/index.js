        ...
        <div className={styles.container}>
            ...
            <div className={styles.tagInfo}>
                <div className={styles.tagInfo__part}>
                    ...
                    <span className={styles.code}>H1219655</span>
                </div>
                ...
                <div className={styles.info}>
                    ...
                    <div className={styles.info__part}>
                        ...
                        <div className="d-flex-js">
                            <span className={styles.title}>Ngân hàng TMCP Kỹ Thương Việt Nam – CN Thăng Long</span>
                ...
                <div className={styles.info}>
                    <div className={styles.info__hotel}>
                        ...
                        <div className={styles.subTitle3}>
                            ...
                            <span>
                                Số 54 Huỳnh Thúc Kháng, Phường Hàm Tiến, Huỳnh Thúc Kháng, Thành Phố Phan Thiết, Bình
                                Thuận, Việt Nam
                            </span>
                        </div>
                    ...
                    <div className={styles.info__order}>
                        <div className={styles.info__order__part}>
                            ...
                            <div className={styles.content2}>
                                <span className={styles.subTitle2}>Trần Thảo Quyên</span>
                                <span className={styles.subTitle2}>+84123456789</span>
                                <span className={styles.subTitle2}>Tranthaoquyen@gmail.com</span>
                            </div>
                        </div>
                        ...
                        <div className={styles.info__order__part}>
                            ...
                            <div className={styles.content1}>
                                ...
                                <div className="d-flex-js">
                                    <span className={styles.subTitle2}>Thời gian nhận phòng dự kiến: &nbsp;</span>
