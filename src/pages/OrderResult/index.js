                            ...
                            <div className={styles.info__order}>
                                <div className={styles.info__order__part}>
                                    ...
                                    <div className={styles.content2}>
                                        <span className={styles.subTitle4}>Trần Thảo Quyên</span>
                                        <div className="d-flex justify-content-start">
                                            <span className={styles.subTitle3}>+84123456789</span>
                                            ...
                                            <span className={styles.subTitle3}>Tranthaoquyen@gmail.com</span>
                                        </div>
                                    </div>
                                    <div className={styles.subTitle5}>
                                        <p>Thông tin người nhận phòng:</p>
                                        <p className={styles.subTitle4}>Trần Thảo Quyên</p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <p className={styles.subTitle1}>1.826.478 ₫</p>
                                    </div>
                                </div>
                            </div>
                        </div>
