    ...
    return <div className={classes.header} >
        <div className={classes.header__nav}>
            <a href="/" className={classes.logo}>
                {/* <h1>SunLight</h1> */}
                <img src="https://storage.googleapis.com/tripi-assets/mytour/icons/icon_logo_mytour_red.svg" className={classes.img} alt="logo_mytour" />
            </a>
            <div className={classes.nav__title}>
                ...
                <TitleButton className="btnTitle" name="Giới thiệu nhận quà" link="/">
                    <svg width="16" height="16" fill="none" style={{ marginRight: '8px' }}>
                        <path
                            ...
                            stroke="#1A202C" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path d="M14.799 4.292h-13.6v2.473h13.6V4.292zM8 4.292V14.8" stroke="#1A202C" strokeLinecap="round"
                ...
                <TitleButton className="btnTitle" name="Hợp tác nhận quà" link="/">
                    <svg width="16" height="16" fill="none" style={{ marginRight: '8px' }}>
                        <path
                            ...
                            stroke="#1A202C" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path
                ...
                <TitleButton className="btnTitle" name="Đơn hàng" link="/" check="true" >
                    <svg width="16" height="16" fill="none" style={{ marginRight: '8px' }}>
                        <path d="M9.2 1.6v3.022a.756.756 0 00.755.755h3.022" stroke="#1A202C" strokeLinecap="round"
                            strokeLinejoin="round"></path>
                        <path
                ...
                <TitleButton className="btnTitle" name="VND" link="/" check="true">
                    <img src="https://storage.googleapis.com/tripi-assets/mytour/icons/icon_lang_vi.png" className={classes.vietnam} alt="" />
                </TitleButton>
                <div className={classes.annouce}>
                    <svg width="20" height="20" fill="none" style={{ stroke: '#000' }}>
                        <path
                        ...
                        <path d="M7.5 14.166V15a2.5 2.5 0 105 0v-.834" stroke="#000" strokeWidth="1.5" strokeLinecap="round"
                            strokeLinejoin="round"></path>
                    </svg>
                </div>
